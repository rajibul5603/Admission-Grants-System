        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                <div class="panel-heading">
                    {{ trans('global.edit') }} {{ trans('cruds.circular.title_singular') }}
                </div>
                <div class="panel-body">
                    <form method="POST" action="{{ route("admin.circulars.update", [$circular->id]) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group {{ $errors->has('circular_type') ? 'has-error' : '' }}">
                            ...
                            <select class="form-control" name="circular_type" id="circular_type" required>
                                ...
                                @foreach(App\Models\Circular::CIRCULAR_TYPE_SELECT as $key => $label)
                                    <option value="{{ $key }}" {{ old('circular_type', $circular->circular_type) === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group {{ $errors->has('cirucular_name') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="cirucular_name" id="cirucular_name" value="{{ old('cirucular_name', $circular->cirucular_name) }}" required>
                        ...
                        <div class="form-group {{ $errors->has('circular_year') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="number" name="circular_year" id="circular_year" value="{{ old('circular_year', $circular->circular_year) }}" step="1">
                        ...
                        <div class="form-group {{ $errors->has('reference_number') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="reference_number" id="reference_number" value="{{ old('reference_number', $circular->reference_number) }}" required>
                        ...
                        <div class="form-group {{ $errors->has('reference_date') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control date" type="text" name="reference_date" id="reference_date" value="{{ old('reference_date', $circular->reference_date) }}" required>
                        ...
                        <div class="form-group {{ $errors->has('academic_year') ? 'has-error' : '' }}">
                            ...
                            <select class="form-control select2" name="academic_year_id" id="academic_year_id" required>
                                @foreach($academic_years as $id => $entry)
                                    <option value="{{ $id }}" {{ (old('academic_year_id') ? old('academic_year_id') : $circular->academic_year->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group {{ $errors->has('policy') ? 'has-error' : '' }}">
                            ...
                            <select class="form-control select2" name="policy_id" id="policy_id" required>
                                @foreach($policies as $id => $entry)
                                    <option value="{{ $id }}" {{ (old('policy_id') ? old('policy_id') : $circular->policy->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group {{ $errors->has('sec_stipend_amount') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="number" name="sec_stipend_amount" id="sec_stipend_amount" value="{{ old('sec_stipend_amount', $circular->sec_stipend_amount) }}" step="0.01" required>
                        ...
                        <div class="form-group {{ $errors->has('hsec_stipend_amount') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="number" name="hsec_stipend_amount" id="hsec_stipend_amount" value="{{ old('hsec_stipend_amount', $circular->hsec_stipend_amount) }}" step="0.01" required>
                        ...
                        <div class="form-group {{ $errors->has('hons_stipend_amount') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="number" name="hons_stipend_amount" id="hons_stipend_amount" value="{{ old('hons_stipend_amount', $circular->hons_stipend_amount) }}" step="0.01" required>
                        ...
                        <div class="form-group {{ $errors->has('application_deadline') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control date" type="text" name="application_deadline" id="application_deadline" value="{{ old('application_deadline', $circular->application_deadline) }}" required>
                        ...
                        <div class="form-group {{ $errors->has('institution_head_deadline') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control date" type="text" name="institution_head_deadline" id="institution_head_deadline" value="{{ old('institution_head_deadline', $circular->institution_head_deadline) }}">
                        ...
                        <div class="form-group {{ $errors->has('circular_status') ? 'has-error' : '' }}">
                            <div>
                                <input type="checkbox" name="circular_status" id="circular_status" value="1" {{ $circular->circular_status || old('circular_status', 0) === 1 ? 'checked' : '' }} required>
